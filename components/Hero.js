    ...
    <section className="hero-section">
      ...
      <div className="hero-copy">
        ...
        <div className="props hero-in" style={{ animationDelay: ".45s" }}>
          <span className="prop">Portions ajustables</span>
          <span className="prop">Temps réalistes</span>
          <span className="prop">Favoris sauvegardés</span>
        </div>
      </div>
