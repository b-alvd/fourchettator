...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f5edde"><tr><td align="center" style="padding:32px 16px">
  ...
  <p style="margin:14px 0 0;font-family:'Hanken Grotesk',Helvetica,Arial,sans-serif;font-size:11px;letter-spacing:1px;text-transform:uppercase;color:#b6a98f">Fourchettator</p>
</td></tr></table>
</body></html>`;
}
